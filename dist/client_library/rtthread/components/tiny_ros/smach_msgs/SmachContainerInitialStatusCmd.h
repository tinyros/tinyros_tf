...
namespace smach_msgs
{
  ...
  class SmachContainerInitialStatusCmd : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return "smach_msgs/SmachContainerInitialStatusCmd"; }
    virtual tinyros::string getMD5(){ return "b7c8a2bbd4d7c89f80561645ea1f4f13"; }
    static tinyros::string getMD5Static(){ return "b7c8a2bbd4d7c89f80561645ea1f4f13"; }
    virtual tinyros::string getDefinition(){ return "string path\nstring[] initial_states\nstring local_data\n"; }
    static tinyros::string getDefinitionStatic(){ return "string path\nstring[] initial_states\nstring local_data\n"; }
