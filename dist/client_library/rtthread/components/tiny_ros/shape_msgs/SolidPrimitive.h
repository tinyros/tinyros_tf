...
namespace shape_msgs
{
  ...
  class SolidPrimitive : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "shape_msgs/SolidPrimitive"; }
    static tinyros::string getTypeStatic(){ return "shape_msgs/SolidPrimitive"; }
    virtual tinyros::string getMD5(){ return "f40805922065416be24909fd8fd751b5"; }
    static tinyros::string getMD5Static(){ return "f40805922065416be24909fd8fd751b5"; }
