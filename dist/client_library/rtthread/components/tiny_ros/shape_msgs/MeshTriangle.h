...
namespace shape_msgs
{
  ...
  class MeshTriangle : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return "shape_msgs/MeshTriangle"; }
    virtual tinyros::string getMD5(){ return "01020cfeb9ad7679dd18bbd7149962ba"; }
    static tinyros::string getMD5Static(){ return "01020cfeb9ad7679dd18bbd7149962ba"; }
    virtual tinyros::string getDefinition(){ return "uint32[3] vertex_indices\n"; }
    static tinyros::string getDefinitionStatic(){ return "uint32[3] vertex_indices\n"; }
