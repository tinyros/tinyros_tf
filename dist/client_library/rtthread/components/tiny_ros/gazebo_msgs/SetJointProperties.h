...
static const char SETJOINTPROPERTIES[] = "gazebo_msgs/SetJointProperties";
  ...
  class SetJointPropertiesRequest : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return SETJOINTPROPERTIES; }
    static tinyros::string getTypeStatic(){ return SETJOINTPROPERTIES; }
    virtual tinyros::string getMD5(){ return "e9063603bda4e7bdd2b5530ad7705661"; }
    static tinyros::string getMD5Static(){ return "e9063603bda4e7bdd2b5530ad7705661"; }
  ...
  class SetJointPropertiesResponse : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return SETJOINTPROPERTIES; }
    static tinyros::string getTypeStatic(){ return SETJOINTPROPERTIES; }
    virtual tinyros::string getMD5(){ return "7e8650b70fd2dfc24b249dddf8f45cee"; }
    static tinyros::string getMD5Static(){ return "7e8650b70fd2dfc24b249dddf8f45cee"; }
