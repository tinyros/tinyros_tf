...
static const char GETPHYSICSPROPERTIES[] = "gazebo_msgs/GetPhysicsProperties";
  ...
  class GetPhysicsPropertiesRequest : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return GETPHYSICSPROPERTIES; }
    static tinyros::string getTypeStatic(){ return GETPHYSICSPROPERTIES; }
    virtual tinyros::string getMD5(){ return "cba4b83a6824644ef787d2ac8bb7aa60"; }
    static tinyros::string getMD5Static(){ return "cba4b83a6824644ef787d2ac8bb7aa60"; }
  ...
  class GetPhysicsPropertiesResponse : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return GETPHYSICSPROPERTIES; }
    static tinyros::string getTypeStatic(){ return GETPHYSICSPROPERTIES; }
    virtual tinyros::string getMD5(){ return "8f17f751935ff418006bf6b24982cb08"; }
    static tinyros::string getMD5Static(){ return "8f17f751935ff418006bf6b24982cb08"; }
    virtual tinyros::string getDefinition(){ return "float64 time_step                  \nbool pause                         \nfloat64 max_update_rate            \ngeometry_msgs/Vector3 gravity      \ngazebo_msgs/ODEPhysics ode_config  \nbool success                       \nstring status_message              \n"; }
    static tinyros::string getDefinitionStatic(){ return "float64 time_step                  \nbool pause                         \nfloat64 max_update_rate            \ngeometry_msgs/Vector3 gravity      \ngazebo_msgs/ODEPhysics ode_config  \nbool success                       \nstring status_message              \n"; }
    static bool hasHeader(){ return false; }
    uint32_t getID() const { return this->__id__; }
    void setID(uint32_t id){ this->__id__ = id; }
