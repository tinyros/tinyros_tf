...
namespace gazebo_msgs
{
  ...
  class LinkStates : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "gazebo_msgs/LinkStates"; }
    static tinyros::string getTypeStatic(){ return "gazebo_msgs/LinkStates"; }
    virtual tinyros::string getMD5(){ return "a6f8cc7b3dee31015716313fe2d419eb"; }
    static tinyros::string getMD5Static(){ return "a6f8cc7b3dee31015716313fe2d419eb"; }
