...
static const char GETLINKSTATE[] = "gazebo_msgs/GetLinkState";
  ...
  class GetLinkStateRequest : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return GETLINKSTATE; }
    virtual tinyros::string getMD5(){ return "b9de4ed1795bda93c873763a2e55e76b"; }
    static tinyros::string getMD5Static(){ return "b9de4ed1795bda93c873763a2e55e76b"; }
  ...
  class GetLinkStateResponse : public tinyros::Msg
  {
    ...
    static tinyros::string getMD5Static(){ return "4d4305d53d97f8edc3b3ce04bcb94ed0"; }
    virtual tinyros::string getDefinition(){ return "gazebo_msgs/LinkState link_state\nbool success              \nstring status_message     \n"; }
    static tinyros::string getDefinitionStatic(){ return "gazebo_msgs/LinkState link_state\nbool success              \nstring status_message     \n"; }
    static bool hasHeader(){ return false; }
    uint32_t getID() const { return this->__id__; }
    void setID(uint32_t id){ this->__id__ = id; }
