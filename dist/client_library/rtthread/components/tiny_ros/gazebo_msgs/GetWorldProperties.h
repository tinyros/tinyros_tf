...
static const char GETWORLDPROPERTIES[] = "gazebo_msgs/GetWorldProperties";
  ...
  class GetWorldPropertiesRequest : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return GETWORLDPROPERTIES; }
    virtual tinyros::string getMD5(){ return "3aa5de7106eec5dae41ad1c9ae681123"; }
    static tinyros::string getMD5Static(){ return "3aa5de7106eec5dae41ad1c9ae681123"; }
  ...
  class GetWorldPropertiesResponse : public tinyros::Msg
  {
    ...
    static tinyros::string getMD5Static(){ return "fe944c1c210919291ad14bc43b6c10cf"; }
    virtual tinyros::string getDefinition(){ return "float64 sim_time                     \nstring[] model_names                 \nbool rendering_enabled               \nbool success                         \nstring status_message                \n"; }
    static tinyros::string getDefinitionStatic(){ return "float64 sim_time                     \nstring[] model_names                 \nbool rendering_enabled               \nbool success                         \nstring status_message                \n"; }
    static bool hasHeader(){ return false; }
    uint32_t getID() const { return this->__id__; }
    void setID(uint32_t id){ this->__id__ = id; }
