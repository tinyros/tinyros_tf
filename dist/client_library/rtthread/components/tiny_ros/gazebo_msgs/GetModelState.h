...
static const char GETMODELSTATE[] = "gazebo_msgs/GetModelState";
  ...
  class GetModelStateRequest : public tinyros::Msg
  {
    ...
    public:
      ...
      typedef tinyros::string _relative_entity_name_type;
    ...
    virtual tinyros::string getType(){ return GETMODELSTATE; }
    static tinyros::string getTypeStatic(){ return GETMODELSTATE; }
    virtual tinyros::string getMD5(){ return "92a8c6443abf59a40e396c81c0e29d40"; }
    static tinyros::string getMD5Static(){ return "92a8c6443abf59a40e396c81c0e29d40"; }
  ...
  class GetModelStateResponse : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return GETMODELSTATE; }
    static tinyros::string getTypeStatic(){ return GETMODELSTATE; }
    virtual tinyros::string getMD5(){ return "3fd873975bc823929b01f7473704b974"; }
    static tinyros::string getMD5Static(){ return "3fd873975bc823929b01f7473704b974"; }
    virtual tinyros::string getDefinition(){ return "geometry_msgs/Pose pose              \ngeometry_msgs/Twist twist            \nbool success                         \nstring status_message                \n"; }
    static tinyros::string getDefinitionStatic(){ return "geometry_msgs/Pose pose              \ngeometry_msgs/Twist twist            \nbool success                         \nstring status_message                \n"; }
    static bool hasHeader(){ return false; }
    uint32_t getID() const { return this->__id__; }
    void setID(uint32_t id){ this->__id__ = id; }
