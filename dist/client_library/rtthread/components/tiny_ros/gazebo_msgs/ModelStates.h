...
namespace gazebo_msgs
{
  ...
  class ModelStates : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "gazebo_msgs/ModelStates"; }
    static tinyros::string getTypeStatic(){ return "gazebo_msgs/ModelStates"; }
    virtual tinyros::string getMD5(){ return "05074231128e3d50825a5f46d9217fda"; }
    static tinyros::string getMD5Static(){ return "05074231128e3d50825a5f46d9217fda"; }
