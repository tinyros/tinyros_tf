...
namespace std_msgs
{
  ...
  class Int32MultiArray : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "std_msgs/Int32MultiArray"; }
    static tinyros::string getTypeStatic(){ return "std_msgs/Int32MultiArray"; }
    virtual tinyros::string getMD5(){ return "d09b4e71ff2be4c9c957c4e4d889034d"; }
    static tinyros::string getMD5Static(){ return "d09b4e71ff2be4c9c957c4e4d889034d"; }
