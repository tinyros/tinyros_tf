...
namespace std_msgs
{
  ...
  class Int16MultiArray : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "std_msgs/Int16MultiArray"; }
    static tinyros::string getTypeStatic(){ return "std_msgs/Int16MultiArray"; }
    virtual tinyros::string getMD5(){ return "5344ae4ffc5e4576421880b487e96c93"; }
    static tinyros::string getMD5Static(){ return "5344ae4ffc5e4576421880b487e96c93"; }
