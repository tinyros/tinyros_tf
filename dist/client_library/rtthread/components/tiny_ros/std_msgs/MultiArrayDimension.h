...
namespace std_msgs
{
  ...
  class MultiArrayDimension : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return "std_msgs/MultiArrayDimension"; }
    virtual tinyros::string getMD5(){ return "c2aacf83d49c7aa4a8504bd32158e990"; }
    static tinyros::string getMD5Static(){ return "c2aacf83d49c7aa4a8504bd32158e990"; }
    virtual tinyros::string getDefinition(){ return "string label   \nuint32 size    \nuint32 stride  \n"; }
    static tinyros::string getDefinitionStatic(){ return "string label   \nuint32 size    \nuint32 stride  \n"; }
