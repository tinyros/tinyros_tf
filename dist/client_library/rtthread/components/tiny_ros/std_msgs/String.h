...
namespace std_msgs
{
  ...
  class String : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return "std_msgs/String"; }
    virtual tinyros::string getMD5(){ return "44b822292b4a9ed05e241aa225458f97"; }
    static tinyros::string getMD5Static(){ return "44b822292b4a9ed05e241aa225458f97"; }
    virtual tinyros::string getDefinition(){ return "string data\n"; }
    static tinyros::string getDefinitionStatic(){ return "string data\n"; }
