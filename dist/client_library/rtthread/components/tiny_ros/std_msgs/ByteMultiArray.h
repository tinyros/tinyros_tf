...
namespace std_msgs
{
  ...
  class ByteMultiArray : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "std_msgs/ByteMultiArray"; }
    static tinyros::string getTypeStatic(){ return "std_msgs/ByteMultiArray"; }
    virtual tinyros::string getMD5(){ return "87f5f1a1253d2ff75093b9a005c3a9a4"; }
    static tinyros::string getMD5Static(){ return "87f5f1a1253d2ff75093b9a005c3a9a4"; }
