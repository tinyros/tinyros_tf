...
namespace std_msgs
{
  ...
  class UInt64 : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return "std_msgs/UInt64"; }
    virtual tinyros::string getMD5(){ return "e815672a5006369d73f91f25ee5609ac"; }
    static tinyros::string getMD5Static(){ return "e815672a5006369d73f91f25ee5609ac"; }
    virtual tinyros::string getDefinition(){ return "uint64 data\n"; }
    static tinyros::string getDefinitionStatic(){ return "uint64 data\n"; }
