...
namespace std_msgs
{
  ...
  class UInt16MultiArray : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "std_msgs/UInt16MultiArray"; }
    static tinyros::string getTypeStatic(){ return "std_msgs/UInt16MultiArray"; }
    virtual tinyros::string getMD5(){ return "a27fbcc6cf43df7ac433688c26323c7b"; }
    static tinyros::string getMD5Static(){ return "a27fbcc6cf43df7ac433688c26323c7b"; }
