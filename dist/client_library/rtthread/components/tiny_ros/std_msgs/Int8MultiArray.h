...
namespace std_msgs
{
  ...
  class Int8MultiArray : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "std_msgs/Int8MultiArray"; }
    static tinyros::string getTypeStatic(){ return "std_msgs/Int8MultiArray"; }
    virtual tinyros::string getMD5(){ return "8e52291bbb3df3ad02224edd2557035e"; }
    static tinyros::string getMD5Static(){ return "8e52291bbb3df3ad02224edd2557035e"; }
