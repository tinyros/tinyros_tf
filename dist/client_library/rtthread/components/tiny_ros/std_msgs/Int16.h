...
namespace std_msgs
{
  ...
  class Int16 : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return "std_msgs/Int16"; }
    virtual tinyros::string getMD5(){ return "156735359f7b6d347f113a1090134af3"; }
    static tinyros::string getMD5Static(){ return "156735359f7b6d347f113a1090134af3"; }
    virtual tinyros::string getDefinition(){ return "int16 data\n"; }
    static tinyros::string getDefinitionStatic(){ return "int16 data\n"; }
