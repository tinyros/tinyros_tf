...
namespace actionlib_msgs
{
  ...
  class GoalStatus : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return "actionlib_msgs/GoalStatus"; }
    virtual tinyros::string getMD5(){ return "086be35ea957e692de83fc3477e4ef0b"; }
    static tinyros::string getMD5Static(){ return "086be35ea957e692de83fc3477e4ef0b"; }
    virtual tinyros::string getDefinition(){ return "GoalID goal_id\nuint8 status\nstring text\n"; }
    static tinyros::string getDefinitionStatic(){ return "GoalID goal_id\nuint8 status\nstring text\n"; }
