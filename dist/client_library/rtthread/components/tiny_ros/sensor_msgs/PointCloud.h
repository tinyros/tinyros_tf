...
namespace sensor_msgs
{
  ...
  class PointCloud : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "sensor_msgs/PointCloud"; }
    static tinyros::string getTypeStatic(){ return "sensor_msgs/PointCloud"; }
    virtual tinyros::string getMD5(){ return "b01249148cae0106a561ab36cd1e48a8"; }
    static tinyros::string getMD5Static(){ return "b01249148cae0106a561ab36cd1e48a8"; }
