...
static const char SETCAMERAINFO[] = "sensor_msgs/SetCameraInfo";
  ...
  class SetCameraInfoRequest : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return SETCAMERAINFO; }
    static tinyros::string getTypeStatic(){ return SETCAMERAINFO; }
    virtual tinyros::string getMD5(){ return "7c09688f428450a1ac49eacdbb57c012"; }
    static tinyros::string getMD5Static(){ return "7c09688f428450a1ac49eacdbb57c012"; }
    virtual tinyros::string getDefinition(){ return "sensor_msgs/CameraInfo camera_info \n"; }
    static tinyros::string getDefinitionStatic(){ return "sensor_msgs/CameraInfo camera_info \n"; }
  ...
  class SetCameraInfoResponse : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return SETCAMERAINFO; }
    static tinyros::string getTypeStatic(){ return SETCAMERAINFO; }
    virtual tinyros::string getMD5(){ return "e03fdc9555d1e3c7347a728e913775f6"; }
    static tinyros::string getMD5Static(){ return "e03fdc9555d1e3c7347a728e913775f6"; }
