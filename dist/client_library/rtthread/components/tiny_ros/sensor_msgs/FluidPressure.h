...
namespace sensor_msgs
{
  ...
  class FluidPressure : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "sensor_msgs/FluidPressure"; }
    static tinyros::string getTypeStatic(){ return "sensor_msgs/FluidPressure"; }
    virtual tinyros::string getMD5(){ return "0fdea137019d78ebf8c2cb91c31a458a"; }
    static tinyros::string getMD5Static(){ return "0fdea137019d78ebf8c2cb91c31a458a"; }
