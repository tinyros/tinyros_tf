...
namespace sensor_msgs
{
  ...
  class LaserEcho : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "sensor_msgs/LaserEcho"; }
    static tinyros::string getTypeStatic(){ return "sensor_msgs/LaserEcho"; }
    virtual tinyros::string getMD5(){ return "a8537b388573845b3240b44db5bc4905"; }
    static tinyros::string getMD5Static(){ return "a8537b388573845b3240b44db5bc4905"; }
    virtual tinyros::string getDefinition(){ return "float32[] echoes  \n"; }
    static tinyros::string getDefinitionStatic(){ return "float32[] echoes  \n"; }
