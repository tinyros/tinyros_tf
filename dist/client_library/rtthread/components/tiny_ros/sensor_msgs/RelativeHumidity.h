...
namespace sensor_msgs
{
  ...
  class RelativeHumidity : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "sensor_msgs/RelativeHumidity"; }
    static tinyros::string getTypeStatic(){ return "sensor_msgs/RelativeHumidity"; }
    virtual tinyros::string getMD5(){ return "d9a3a4b2c3c0c55eede767d38b460110"; }
    static tinyros::string getMD5Static(){ return "d9a3a4b2c3c0c55eede767d38b460110"; }
