...
namespace sensor_msgs
{
  ...
  class BatteryState : public tinyros::Msg
  {
    public:
      ...
      typedef tinyros::string _location_type;
      _location_type location;
      typedef tinyros::string _serial_number_type;
    ...
    virtual tinyros::string getType(){ return "sensor_msgs/BatteryState"; }
    static tinyros::string getTypeStatic(){ return "sensor_msgs/BatteryState"; }
    virtual tinyros::string getMD5(){ return "715c4769cacd76e4b679cc3ea4c347b4"; }
    static tinyros::string getMD5Static(){ return "715c4769cacd76e4b679cc3ea4c347b4"; }
