...
namespace sensor_msgs
{
  ...
  class CameraInfo : public tinyros::Msg
  {
    public:
      ...
      _width_type width;
      typedef tinyros::string _distortion_model_type;
    ...
    virtual tinyros::string getType(){ return "sensor_msgs/CameraInfo"; }
    static tinyros::string getTypeStatic(){ return "sensor_msgs/CameraInfo"; }
    virtual tinyros::string getMD5(){ return "57d2553deec0a7842f00837f40032798"; }
    static tinyros::string getMD5Static(){ return "57d2553deec0a7842f00837f40032798"; }
