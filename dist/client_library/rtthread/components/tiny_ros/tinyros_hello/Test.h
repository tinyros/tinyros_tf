...
static const char TEST[] = "tinyros_hello/Test";
  ...
  class TestRequest : public tinyros::Msg
  {
    ...
    public:
      typedef tinyros::string _input_type;
      _input_type input;
    ...
    virtual tinyros::string getType(){ return TEST; }
    static tinyros::string getTypeStatic(){ return TEST; }
    virtual tinyros::string getMD5(){ return "26ee7a44335f1f7b55a5a7490460807d"; }
    static tinyros::string getMD5Static(){ return "26ee7a44335f1f7b55a5a7490460807d"; }
    virtual tinyros::string getDefinition(){ return "string input\n"; }
    static tinyros::string getDefinitionStatic(){ return "string input\n"; }
  ...
  class TestResponse : public tinyros::Msg
  {
    ...
    public:
      typedef tinyros::string _output_type;
      _output_type output;
    ...
    virtual tinyros::string getType(){ return TEST; }
    static tinyros::string getTypeStatic(){ return TEST; }
    virtual tinyros::string getMD5(){ return "e2f6296e6ea9df7406f4fac9fb52d44b"; }
    static tinyros::string getMD5Static(){ return "e2f6296e6ea9df7406f4fac9fb52d44b"; }
    virtual tinyros::string getDefinition(){ return "string output\n"; }
    static tinyros::string getDefinitionStatic(){ return "string output\n"; }
    static bool hasHeader(){ return false; }
    uint32_t getID() const { return this->__id__; }
    void setID(uint32_t id){ this->__id__ = id; }
