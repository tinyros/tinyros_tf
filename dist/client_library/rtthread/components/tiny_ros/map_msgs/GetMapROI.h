...
static const char GETMAPROI[] = "map_msgs/GetMapROI";
  ...
  class GetMapROIRequest : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return GETMAPROI; }
    virtual tinyros::string getMD5(){ return "f74ea8c8dc9b857aae7ea10033520d28"; }
    static tinyros::string getMD5Static(){ return "f74ea8c8dc9b857aae7ea10033520d28"; }
  ...
  class GetMapROIResponse : public tinyros::Msg
  {
    ...
    static tinyros::string getMD5Static(){ return "a178ec520c3d0d99d9d85c70ed4b535a"; }
    virtual tinyros::string getDefinition(){ return "nav_msgs/OccupancyGrid sub_map\n"; }
    static tinyros::string getDefinitionStatic(){ return "nav_msgs/OccupancyGrid sub_map\n"; }
    static bool hasHeader(){ return false; }
    uint32_t getID() const { return this->__id__; }
    void setID(uint32_t id){ this->__id__ = id; }
