...
namespace map_msgs
{
  ...
  class OccupancyGridUpdate : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "map_msgs/OccupancyGridUpdate"; }
    static tinyros::string getTypeStatic(){ return "map_msgs/OccupancyGridUpdate"; }
    virtual tinyros::string getMD5(){ return "159b2d7856932f2e2cad9b082ed99ec2"; }
    static tinyros::string getMD5Static(){ return "159b2d7856932f2e2cad9b082ed99ec2"; }
