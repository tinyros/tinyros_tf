...
namespace geometry_msgs
{
  ...
  class AccelWithCovariance : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "geometry_msgs/AccelWithCovariance"; }
    static tinyros::string getTypeStatic(){ return "geometry_msgs/AccelWithCovariance"; }
    virtual tinyros::string getMD5(){ return "6c9c3b4380e0391a48b0a1be79b38ac6"; }
    static tinyros::string getMD5Static(){ return "6c9c3b4380e0391a48b0a1be79b38ac6"; }
    virtual tinyros::string getDefinition(){ return "Accel accel\nfloat64[36] covariance\n"; }
    static tinyros::string getDefinitionStatic(){ return "Accel accel\nfloat64[36] covariance\n"; }
