...
namespace nav_msgs
{
  ...
  class GetMapAction : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "nav_msgs/GetMapAction"; }
    static tinyros::string getTypeStatic(){ return "nav_msgs/GetMapAction"; }
    virtual tinyros::string getMD5(){ return "10a4e277d7b8e53bfc3df54d98b3edb1"; }
    static tinyros::string getMD5Static(){ return "10a4e277d7b8e53bfc3df54d98b3edb1"; }
    virtual tinyros::string getDefinition(){ return "GetMapActionGoal action_goal\nGetMapActionResult action_result\nGetMapActionFeedback action_feedback\n"; }
    static tinyros::string getDefinitionStatic(){ return "GetMapActionGoal action_goal\nGetMapActionResult action_result\nGetMapActionFeedback action_feedback\n"; }
