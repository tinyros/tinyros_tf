...
namespace trajectory_msgs
{
  ...
  class JointTrajectoryPoint : public tinyros::Msg
  {
    ...
    virtual tinyros::string getType(){ return "trajectory_msgs/JointTrajectoryPoint"; }
    static tinyros::string getTypeStatic(){ return "trajectory_msgs/JointTrajectoryPoint"; }
    virtual tinyros::string getMD5(){ return "38679319321341510f6fde7d7f745eb0"; }
    static tinyros::string getMD5Static(){ return "38679319321341510f6fde7d7f745eb0"; }
    virtual tinyros::string getDefinition(){ return "float64[] positions\nfloat64[] velocities\nfloat64[] accelerations\nfloat64[] effort\nduration time_from_start\n"; }
    static tinyros::string getDefinitionStatic(){ return "float64[] positions\nfloat64[] velocities\nfloat64[] accelerations\nfloat64[] effort\nduration time_from_start\n"; }
