...
namespace tinyros_msgs
{
  ...
  class Log : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return "tinyros_msgs/Log"; }
    virtual tinyros::string getMD5(){ return "0bd74339b4d77cb15766d831a3d15eeb"; }
    static tinyros::string getMD5Static(){ return "0bd74339b4d77cb15766d831a3d15eeb"; }
    virtual tinyros::string getDefinition(){ return "uint8 level\nstring msg\n"; }
    static tinyros::string getDefinitionStatic(){ return "uint8 level\nstring msg\n"; }
