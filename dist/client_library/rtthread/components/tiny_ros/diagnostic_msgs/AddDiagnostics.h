...
static const char ADDDIAGNOSTICS[] = "diagnostic_msgs/AddDiagnostics";
  ...
  class AddDiagnosticsRequest : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return ADDDIAGNOSTICS; }
    virtual tinyros::string getMD5(){ return "005ba76b3cd04edebfe46acad928fbeb"; }
    static tinyros::string getMD5Static(){ return "005ba76b3cd04edebfe46acad928fbeb"; }
    virtual tinyros::string getDefinition(){ return "string load_namespace\n"; }
    static tinyros::string getDefinitionStatic(){ return "string load_namespace\n"; }
  ...
  class AddDiagnosticsResponse : public tinyros::Msg
  {
    ...
    static tinyros::string getMD5Static(){ return "9bd37b30a2340a31743d1e80a2c52ed0"; }
