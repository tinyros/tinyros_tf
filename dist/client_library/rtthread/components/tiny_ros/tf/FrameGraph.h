...
static const char FRAMEGRAPH[] = "tf/FrameGraph";
  ...
  class FrameGraphRequest : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return FRAMEGRAPH; }
    virtual tinyros::string getMD5(){ return "d66179e20d21cee31291f40363976e1d"; }
    static tinyros::string getMD5Static(){ return "d66179e20d21cee31291f40363976e1d"; }
  ...
  class FrameGraphResponse : public tinyros::Msg
  {
    ...
    static tinyros::string getMD5Static(){ return "8528671f80a5c0815f9700a446efbc36"; }
    virtual tinyros::string getDefinition(){ return "string dot_graph\n"; }
    static tinyros::string getDefinitionStatic(){ return "string dot_graph\n"; }
    static bool hasHeader(){ return false; }
    uint32_t getID() const { return this->__id__; }
    void setID(uint32_t id){ this->__id__ = id; }
