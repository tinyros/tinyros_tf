...
static const char TRIGGER[] = "std_srvs/Trigger";
  ...
  class TriggerRequest : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return TRIGGER; }
    virtual tinyros::string getMD5(){ return "23ce35174a691cb0bfbbdb21395edbac"; }
    static tinyros::string getMD5Static(){ return "23ce35174a691cb0bfbbdb21395edbac"; }
  ...
  class TriggerResponse : public tinyros::Msg
  {
    ...
    static tinyros::string getMD5Static(){ return "08d111154ed595049573252ba929a6d8"; }
