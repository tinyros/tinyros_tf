...
static const char EMPTY[] = "std_srvs/Empty";
  ...
  class EmptyRequest : public tinyros::Msg
  {
    ...
    static tinyros::string getTypeStatic(){ return EMPTY; }
    virtual tinyros::string getMD5(){ return "6a9da448a5a2256d30e815f50a75bc57"; }
    static tinyros::string getMD5Static(){ return "6a9da448a5a2256d30e815f50a75bc57"; }
  ...
  class EmptyResponse : public tinyros::Msg
  {
    ...
    static tinyros::string getMD5Static(){ return "1b9fedd0c70a6b7846f790471f388d15"; }
    virtual tinyros::string getDefinition(){ return ""; }
    static tinyros::string getDefinitionStatic(){ return ""; }
    static bool hasHeader(){ return false; }
    uint32_t getID() const { return this->__id__; }
