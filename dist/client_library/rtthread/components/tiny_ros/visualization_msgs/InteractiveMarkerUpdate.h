...
namespace visualization_msgs
{
  ...
  class InteractiveMarkerUpdate : public tinyros::Msg
  {
    public:
      ...
      typedef tinyros::string _erases_type;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(poses_lengthT > poses_length)
        this->poses = (tinyros::visualization_msgs::InteractiveMarkerPose*)realloc(this->poses, poses_lengthT * sizeof(tinyros::visualization_msgs::InteractiveMarkerPose));
      poses_length = poses_lengthT;
      for( uint32_t i = 0; i < poses_length; i++) {
        offset += this->st_poses.deserialize(inbuffer + offset);
        memcpy( &(this->poses[i]), &(this->st_poses), sizeof(tinyros::visualization_msgs::InteractiveMarkerPose));
      }
      ...
      if(erases_lengthT > erases_length)
        this->erases = (tinyros::string*)realloc(this->erases, erases_lengthT * sizeof(tinyros::string));
      ...
      for( uint32_t i = 0; i < erases_length; i++) {
        ...
        memcpy( &(this->erases[i]), &(this->st_erases), sizeof(tinyros::string));
      }
      return offset;
    }
    ...
    virtual tinyros::string getType(){ return "visualization_msgs/InteractiveMarkerUpdate"; }
    static tinyros::string getTypeStatic(){ return "visualization_msgs/InteractiveMarkerUpdate"; }
    virtual tinyros::string getMD5(){ return "ae37189a6cc8de1bae3ccd7710af4288"; }
    static tinyros::string getMD5Static(){ return "ae37189a6cc8de1bae3ccd7710af4288"; }
