...
namespace visualization_msgs
{
  ...
  class InteractiveMarkerFeedback : public tinyros::Msg
  {
    public:
      ...
      _header_type header;
      typedef tinyros::string _client_id_type;
      _client_id_type client_id;
      typedef tinyros::string _marker_name_type;
      _marker_name_type marker_name;
      typedef tinyros::string _control_name_type;
    ...
    virtual tinyros::string getType(){ return "visualization_msgs/InteractiveMarkerFeedback"; }
    static tinyros::string getTypeStatic(){ return "visualization_msgs/InteractiveMarkerFeedback"; }
    virtual tinyros::string getMD5(){ return "2b2c717ae73a04857e91f4992896e58f"; }
    static tinyros::string getMD5Static(){ return "2b2c717ae73a04857e91f4992896e58f"; }
