...
static const char SAVEMAP[] = "map_msgs/SaveMap";
  ...
  class SaveMapRequest : public tinyros::Msg
  {
    ...
    static std::string getTypeStatic(){ return SAVEMAP; }
    virtual std::string getMD5(){ return "6643d8ede81a23998690e6a3ff657316"; }
    static std::string getMD5Static(){ return "6643d8ede81a23998690e6a3ff657316"; }
    virtual std::string getDefinition(){ return "std_msgs/String filename\n"; }
    static std::string getDefinitionStatic(){ return "std_msgs/String filename\n"; }
...
typedef std::shared_ptr<tinyros::map_msgs::SaveMapRequest const> SaveMapRequestConstPtr;
  ...
  class SaveMapResponse : public tinyros::Msg
  {
    ...
    static std::string getMD5Static(){ return "9cd07446fa1bd59b4758dadf19f196e9"; }
