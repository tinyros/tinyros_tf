...
class InteractiveMarker(tinyros.Message):
    ...
    _slot_types = ['std_msgs.msg.Header','geometry_msgs.msg.Pose','string','string','float32','visualization_msgs.msg.MenuEntry[]','visualization_msgs.msg.InteractiveMarkerControl[]']
