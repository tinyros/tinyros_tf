...
static const char SETMODELSTATE[] = "gazebo_msgs/SetModelState";
  ...
  class SetModelStateRequest : public tinyros::Msg
  {
    ...
    static std::string getMD5Static(){ return "328e9e434938c39f3fd8e958ad8d6dab"; }
    virtual std::string getDefinition(){ return "gazebo_msgs/ModelState model_state\n"; }
    static std::string getDefinitionStatic(){ return "gazebo_msgs/ModelState model_state\n"; }
