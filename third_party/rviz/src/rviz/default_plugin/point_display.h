...
namespace rviz
{
    ...
    class PointStampedDisplay: public rviz::MessageFilterDisplay<tinyros::geometry_msgs::PointStamped>
    {
    Q_OBJECT
    public:
    ...
    private:
    void processMessage( const tinyros::geometry_msgs::PointStamped::ConstPtr& msg );
