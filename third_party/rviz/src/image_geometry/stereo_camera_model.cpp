...
bool StereoCameraModel::fromCameraInfo(const tinyros::sensor_msgs::CameraInfo& left,
                                       const tinyros::sensor_msgs::CameraInfo& right)
{
...
bool StereoCameraModel::fromCameraInfo(const tinyros::sensor_msgs::CameraInfoConstPtr& left,
                                       const tinyros::sensor_msgs::CameraInfoConstPtr& right)
{
