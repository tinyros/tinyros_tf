...
bool PinholeCameraModel::fromCameraInfo(const tinyros::sensor_msgs::CameraInfo& msg)
{
  ...
  tinyros::sensor_msgs::RegionOfInterest roi = msg.roi;
  ...
  if (cam_info_.distortion_model == rviz::distortion_models::PLUMB_BOB ||
      cam_info_.distortion_model == rviz::distortion_models::RATIONAL_POLYNOMIAL) {
...
bool PinholeCameraModel::fromCameraInfo(const tinyros::sensor_msgs::CameraInfoConstPtr& msg)
{
