...
class MultiDOFJointTrajectory(tinyros.Message):
    ...
    def deserialize(self, buff):
        ...
        try:
            ...
            self.points = [trajectory_msgs.msg.MultiDOFJointTrajectoryPoint() for x in range(0, points_length)]
            offset += 4
            for i in range(0, points_length):
    ...
    def getMD5(self):
        return "19f97d4cdcae9d0ef55126c1495f6c91"
