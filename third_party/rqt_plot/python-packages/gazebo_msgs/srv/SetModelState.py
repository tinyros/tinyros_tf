...
class SetModelStateRequest(tinyros.Message):
    __slots__ = ['__id__','model_state']
    _slot_types = ['uint32','gazebo_msgs/ModelState']

    def __init__(self):
        super(SetModelStateRequest, self).__init__()
        self.__id__ = 0
    ...
    def serialize(self, buff):
        ...
        offset += self.model_state.serialize(buff)
        return offset
    ...
    def deserialize(self, buff):
        ...
        offset += self.model_state.deserialize(buff[offset:])
        return offset

    def serializedLength(self):
        length = 0
        length += 4
        length += self.model_state.serializedLength()
        return length
    ...
    def echo(self):
        ...
        string_echo += self.model_state.echo()
        string_echo += '}'
        string_echo += '}'
        return string_echo
    ...
    def getMD5(self):
        return "328e9e434938c39f3fd8e958ad8d6dab"
...
class SetModelStateResponse(tinyros.Message):
    __slots__ = ['__id__','success','status_message']
    _slot_types = ['uint32','bool','string']

    def __init__(self):
        super(SetModelStateResponse, self).__init__()
        self.__id__ = 0
        self.success = False
        self.status_message = ''
    ...
    def getMD5(self):
        return "7fe6c3a1ea4a4df9bf5b6858fd028ee6"
