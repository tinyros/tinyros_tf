...
class UInt16MultiArray(tinyros.Message):
    ...
    def deserialize(self, buff):
        ...
        try:
            ...
            for i in range(0, data_length):
                try:
                    struct_datai = struct.Struct("<H")
                    (self.data[i],) = struct_datai.unpack(buff[offset:(offset + 2)])
                    offset += 2
                except struct.error as ex:
    ...
    def getMD5(self):
        return "a27fbcc6cf43df7ac433688c26323c7b"
