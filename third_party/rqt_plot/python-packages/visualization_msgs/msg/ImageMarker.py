...
class ImageMarker(tinyros.Message):
    ...
    _slot_types = ['std_msgs/Header','string','int32','int32','int32','geometry_msgs/Point','float32','std_msgs/ColorRGBA','uint8','std_msgs/ColorRGBA','tinyros.Duration','geometry_msgs/Point[]','std_msgs/ColorRGBA[]']
