...
class Marker(tinyros.Message):
    ...
    _slot_types = ['std_msgs/Header','string','int32','int32','int32','geometry_msgs/Pose','geometry_msgs/Vector3','std_msgs/ColorRGBA','tinyros.Duration','bool','geometry_msgs/Point[]','std_msgs/ColorRGBA[]','string','string','bool']
